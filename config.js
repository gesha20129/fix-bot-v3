...
global.sig = 'https://instagram.com/geshrfd' // ig
global.sgh = 'https://github.com//' // github
global.sgc = '-' // group whatsapp
global.sdc = '-'//discord
global.snh = 'https://youtube.com/channel/UCWgc-_sSNyOGqvgY2RxR1YA' // my youtube channel
...
global.ppulsa = '085891318105' //telkomsel
...
global.namebot = 'ANU BOT'
global.nameown = 'Gesha'
...
/*============== WATERMARK ==============*/
global.wm = '                「 ANU - BOTZZ 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ANU-BOTZZ ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ANU-BOTZZ '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot `
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 ANU BOTZ  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Gesha'
global.stickauth = `By Anu BOTZ`
